...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'manage_access': 'Manage how you access your account',
      'biometric_login_desc': 'Face or Fingerprint unlock',
      'enroll_face_title': 'Enroll/Update Face',
      'enroll_face_desc': 'Register your biometric profile',
      'field_operations': 'Field Operations',
      'field_ops_desc': 'Control live tracking and status',
      'duty_status_desc': 'Live location and activity sync',
      'account_protection': 'Account Protection',
      'security_layers': 'Security layers for your profile',
      'change_pin_desc': 'Last changed 30 days ago',
      'device_mgmt_desc': 'active sessions',
      'search_collections': 'Search collections...',
      'my_total_collection': 'My Total Collection',
      'my_stats': 'My Stats',
      ...
      'my_ai_performance': 'My AI Performance',
      'tally': 'Tally',
      'daily_tally': 'Daily Tally',
      'search_customers_hint': 'Search customers...',
      'outstanding_balance': 'Outstanding Balance',
      'overdue': 'Overdue',
      'collected_today_pulse': 'COLLECTED TODAY',
      ...
      'principal': 'Principal',
      'interest': 'Interest',
      'view_history_archives': 'VIEW HISTORY & ARCHIVES',
      'problem_loans_alert': 'PROBLEM LOANS ALERT',
      'ai_assistant_title': 'AI ASSISTANT',
      'daily_recovery_pulse': 'Daily Recovery Pulse',
      'agents_live': 'Agents Live',
      'upi_payment_title': 'UPI Payment',
      'scan_any_upi_hint': 'Scan with any UPI App',
      'pay_via_apps_hint': 'Or click below to pay directly using apps installed on your phone:',
      'pay_via_installed_apps': 'Pay via Installed Apps',
      'no_upi_app_found': 'No UPI app found on this device',
      'pay_to_upi_id': 'Pay to UPI ID',
      'generate_dynamic_qr': 'GENERATE DYNAMIC QR',
      'enter_valid_amount_first': 'Enter a valid amount first',
    ...
    'ta': {
      ...
      'manage_access': 'உங்கள் கணக்கை எவ்வாறு அணுகுவது என்பதை நிர்வகிக்கவும்',
      'biometric_login_desc': 'முகம் அல்லது கைரேகை மூலம் திறக்கவும்',
      'enroll_face_title': 'முகத்தை பதிவு செய்யவும்/புதுப்பிக்கவும்',
      'enroll_face_desc': 'உங்கள் பயோமெட்ரிக் விவரங்களை பதிவு செய்யவும்',
      'field_operations': 'களச் செயல்பாடுகள்',
      'field_ops_desc': 'நேரடி கண்காணிப்பு மற்றும் நிலையை கட்டுப்படுத்தவும்',
      'duty_status_desc': 'நேரடி இருப்பிடம் மற்றும் செயல்பாட்டு ஒத்திசைவு',
      'account_protection': 'கணக்கு பாதுகாப்பு',
      'security_layers': 'உங்கள் சுயவிவரத்திற்கான பாதுகாப்பு அடுக்குகள்',
      'change_pin_desc': 'கடைசியாக 30 நாட்களுக்கு முன்பு மாற்றப்பட்டது',
      'device_mgmt_desc': 'செயலில் உள்ள அமர்வுகள்',
      'search_collections': 'வசூல்களைத் தேடுங்கள்...',
      'my_total_collection': 'எனது மொத்த வசூல்',
      'my_stats': 'எனது புள்ளிவிவரங்கள்',
      'no_recent_collections': 'சமீபத்திய வசூல்கள் எதுவும் இல்லை',
      'recently': 'சமீபத்தில்',
      'track_all': 'அனைத்தையும் கண்காணிக்கவும்',
      'database_viewer': 'தரவுத்தள பார்வை',
      'customer_management': 'வாடிக்கையாளர் மேலாண்மை',
      'administrator': 'நிர்வாகி',
      'field_agent_role': 'களப் பணியாளர்',
      'my_ai_performance': 'எனது AI செயல்பாடு',
      'tally': 'டேலி',
      'daily_tally': 'தினசரி கணக்கு',
      'search_customers_hint': 'வாடிக்கையாளர்களைத் தேடுங்கள்...',
      'outstanding_balance': 'நிலுவையில் உள்ள தொகை',
      'overdue': 'காலாவதியானது',
      'collected_today_pulse': 'இன்று வசூலிக்கப்பட்டது',
      'top_performers': 'சிறந்த பணியாளர்கள்',
      'morning': 'காலை',
      'evening': 'மாலை',
      'cash': 'பணம்',
      'upi': 'யுபிஐ (UPI)',
      'principal': 'அசல்',
      'interest': 'வட்டி',
      'view_history_archives': 'வரலாற்றைக் காண்க',
      'problem_loans_alert': 'சிக்கலான கடன் எச்சரிக்கை',
      'ai_assistant_title': 'AI உதவியாளர்',
      'daily_recovery_pulse': 'தினசரி வசூல் நிலை',
      'agents_live': 'பணியாளர்கள் நேரலையில்',
      'upi_payment_title': 'யுபிஐ (UPI) கட்டணம்',
      'scan_any_upi_hint': 'ஏதேனும் ஒரு யுபிஐ (UPI) செயலி மூலம் ஸ்கேன் செய்யவும்',
      'pay_via_apps_hint': 'அல்லது உங்கள் போனில் உள்ள செயலிகளைப் பயன்படுத்தி நேரடியாகக் கட்டணம் செலுத்த கீழே கிளிக் செய்யவும்:',
      'pay_via_installed_apps': 'நிறுவப்பட்டுள்ள செயலிகள் மூலம் செலுத்தவும்',
      'no_upi_app_found': 'இந்த சாதனத்தில் யுபிஐ (UPI) செயலி ஏதும் காணப்படவில்லை',
      'pay_to_upi_id': 'இந்த யுபிஐ (UPI) ஐடி-க்கு செலுத்தவும்',
      'generate_dynamic_qr': 'கட்டண க்யூஆர் (QR) உருவாக்கவும்',
      'enter_valid_amount_first': 'முதலில் சரியான தொகையை உள்ளிடவும்',
      'upi_id_copied': 'யுபிஐ (UPI) ஐடி நகலெடுக்கப்பட்டது',
      'daily_report': 'தினசரி அறிக்கை',
      'weekly_report': 'வாராந்திர அறிக்கை',
      'customer_breakdown': 'வாடிக்கையாளர் விவரங்கள்',
      'paid_total': 'மொத்த வசூல்',
      'target_achieved': 'இலக்கு எட்டப்பட்டது',
      'timeline': 'காலவரிசை',
      'view_timeline': 'காலவரிசையைக் காண்க',
      'starting_point': 'தொடக்க இடம்',
      'movement_history': 'பயண வரலாறு',
      'gps_off': 'ஜிபிஎஸ் (GPS) முடக்கப்பட்டுள்ளது',
