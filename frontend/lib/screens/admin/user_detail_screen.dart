                            ...
                            child: _loginStats == null
                              ...
                              : Column(
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Icon(Icons.access_time_rounded, color: AppTheme.secondaryTextColor, size: 20),
                                        const SizedBox(width: 12),
                                        Text(
                                          context.translate('last_login_label'),
                                          style: TextStyle(color: AppTheme.secondaryTextColor, fontSize: 14, fontWeight: FontWeight.w600),
                                        ),
                                    ...
                                    if (_loginStats!['devices'] != null && (_loginStats!['devices'] as List).isNotEmpty) ...[
                                      ...
                                      Row(
                                        children: [
                                          Icon(Icons.devices_rounded, color: AppTheme.secondaryTextColor, size: 20),
                                          const SizedBox(width: 12),
                                          Text(
                                        ...
                                        child: Row(
                                          children: [
                                            Icon(
                                              ...
                                              color: device['is_trusted'] == true ? AppTheme.primaryColor : AppTheme.secondaryTextColor,
                                              size: 18,
                                            ),
                                            const SizedBox(width: 12),
                                            Expanded(
                              ...
                              child: Column(
                                children: [
                                  Text(
                                    ...
                                    style: GoogleFonts.outfit(fontWeight: FontWeight.w600, fontSize: 14, color: AppTheme.secondaryTextColor),
                                  ),
                                  const SizedBox(height: 16),
                                  Container(
                                  ...
                                  Text(
                                    _qrToken!,
                                    style: TextStyle(color: AppTheme.secondaryTextColor, fontSize: 11, fontFamily: 'monospace'),
                                  ),
                                ],
                              ),
                            ),
                              ...
                              : Column(
                                  ...
                                  children: [
                                    ...
                                    if (_biometricsInfo!['has_biometric'] == true && _biometricsInfo!['device_id'] != null) ...[
                                      ...
                                      Row(
                                        children: [
                                          Icon(Icons.phone_android_rounded, color: AppTheme.secondaryTextColor, size: 16),
                                          const SizedBox(width: 8),
                                          Text(
                                            'Device ID:',
                                            style: TextStyle(color: AppTheme.secondaryTextColor, fontSize: 13, fontWeight: FontWeight.w600),
                                          ),
                                          const SizedBox(width: 4),
                                          Expanded(
                                            child: Text(
                                              _biometricsInfo!['device_id'].toString(),
                                              style: TextStyle(color: AppTheme.textColor, fontSize: 13, fontFamily: 'monospace'),
